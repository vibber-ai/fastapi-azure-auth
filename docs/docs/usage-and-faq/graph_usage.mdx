...
:::info
This documentation is based off [issue #40](https://github.com/vibber-ai/fastapi-azure-auth/issues/40)
:::
...
[demo project](https://github.com/vibber-ai/fastapi-azure-auth/blob/main/demo_project/api/api_v1/endpoints/graph.py).
