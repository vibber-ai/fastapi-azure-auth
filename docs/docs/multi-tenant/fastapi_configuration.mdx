...
[demo_project](https://github.com/vibber-ai/fastapi-azure-auth/tree/main/demo_project) on GitHub. This is configured
...
<GitHubButton href="https://github.com/vibber-ai/fastapi-azure-auth"
              data-color-scheme="no-preference: dark_dimmed; light: dark_dimmed; dark: dark_dimmed;"
              data-icon="octicon-star" data-size="large" data-show-count="true"
              aria-label="Star vibber-ai/fastapi-azure-auth on GitHub">Star</GitHubButton>
</div>
